...
export function FIICashUpload() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const expectedHeaders = ['Date', 'FII_EQUITY_Gross_Purchase', 'FII_EQUITY_Gross_Sales', 'FII_EQUITY_Net', 'FII_DEBT_Gross_Purchase', 'FII_DEBT_Gross_Sales', 'FII_DEBT_Net'];
  ...
  const downloadTemplate = () => {
    ...
    link.href = '/templates/fii_cash_template.csv';
    link.download = 'fii_cash_template.csv';
    link.click();
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>FII Cash Data Upload</CardTitle>
        <CardDescription>
          Upload daily FII cash market data (Equity and Debt breakdown)
        </CardDescription>
      </CardHeader>
