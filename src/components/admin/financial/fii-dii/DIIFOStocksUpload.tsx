...
export function DIIFOStocksUpload() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const expectedHeaders = ['Date', 'DII_FUTURES_Gross_Purchase', 'DII_FUTURES_Gross_Sales', 'DII_FUTURES_Net', 'DII_OPTIONS_Gross_Purchase', 'DII_OPTIONS_Gross_Sales', 'DII_OPTIONS_Net'];
  ...
  const downloadTemplate = () => {
    ...
    link.href = '/templates/dii_fo_stocks_template.csv';
    link.download = 'dii_fo_stocks_template.csv';
    link.click();
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>DII F&O Stocks Data Upload (MF F&O)</CardTitle>
        <CardDescription>
          Upload daily DII/Mutual Fund Futures & Options data on Stocks
        </CardDescription>
      </CardHeader>
