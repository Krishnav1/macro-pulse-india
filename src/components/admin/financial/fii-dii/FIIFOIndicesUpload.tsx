...
export function FIIFOIndicesUpload() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const expectedHeaders = ['Date', 'FII_FUTURES_Gross_Purchase_Indices', 'FII_FUTURES_Gross_Sales_Indices', 'FII_FUTURES_Net_Indices', 'FII_OPTIONS_Gross_Purchase_Indices', 'FII_OPTIONS_Gross_Sales_Indices', 'FII_OPTIONS_Net_Indices'];
  ...
  const downloadTemplate = () => {
    ...
    link.href = '/templates/fii_fo_indices_template.csv';
    link.download = 'fii_fo_indices_template.csv';
    link.click();
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>FII F&O Indices Data Upload</CardTitle>
        <CardDescription>
          Upload daily FII Futures & Options data on Indices
        </CardDescription>
      </CardHeader>
